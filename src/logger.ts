...
export function FormatErrorObject(object: any) {
  ...
  const { CONSOLE_LOG_JSON_NO_NEW_LINE_CHARACTERS, CONSOLE_LOG_JSON_NO_NEW_LINE_END_OF_LOG } = process.env;
  ...
  if (CONSOLE_LOG_JSON_NO_NEW_LINE_CHARACTERS || CONSOLE_LOG_JSON_NO_NEW_LINE_END_OF_LOG) {
    endOfLogCharacter = '';
  }
